...
public class ArrayListUsingIteratorInSwing extends  JFrame{
    JLabel l1,l2;
    JTextField t1,t2;
    JTextArea ta;
    JButton b1,b2,b3,b4,b5;
    ArrayList<String> student =new ArrayList<String>();
    public ArrayListUsingIteratorInSwing() {
    ...
    public static void main(String[] args) {
        ArrayListUsingIteratorInSwing arl=new ArrayListUsingIteratorInSwing();
    }
}

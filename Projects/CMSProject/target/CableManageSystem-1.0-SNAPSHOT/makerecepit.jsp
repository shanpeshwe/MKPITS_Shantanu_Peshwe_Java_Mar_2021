...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center">
      ...
      <div class="sidebar-brand-text mx-3">Cable CMS</div>
    </a>
    ...
    <li class="nav-item active">
      <a class="nav-link" href="dashboard.html">
        ...
        <span style="margin:10px">Dashboard</span></a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
        ...
        <span style="margin:10px">Search</span>
      </a>
      <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Search For</h6>
          <a class="collapse-item" href="searchcustomer.html">Customer</a>
          <a class="collapse-item" href="searchactiveconnection.html">Active Connection</a>
          <a class="collapse-item" href="searchinactiveconnection.html">Inactive Connection</a>
          <a class="collapse-item" href="searchreceipt.jsp">Receipts</a>
     ...
     Nav Item - Charts 
    <li class="nav-item">
      <a class="nav-link" href="makerecepit.jsp">
         Icon Image 
        ...
        <span style="margin:10px">Make Reciept</span></a>
    </li>

     Nav Item - Tables 
    <li class="nav-item">
      <a class="nav-link" href="customerbilling.jsp">
         Icon Image 
        ...
        <span style="margin:10px">Customer Billing</span></a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
        ...
        <span style="margin:10px">Master</span>
      </a>
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Master Components</h6>
          <a class="collapse-item" href="addcustomer.jsp">Add Customer</a>
          <a class="collapse-item" href=" addarea.html">Add Area</a>
          <a class="collapse-item" href="addpackage.html">Add Package</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" href="manageprofile.html">
         Icon Image 
        ...
        <span style="margin:10px">Manage Profile</span></a>
    </li>
    <br>
    ...
    <div id="content">
      ...
      <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto">
           ...
           Nav Item 
          <p style="margin-top: 20px">Fin Year : 2021-2022</p>
          ...
          <a href="login.html" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin: 18px">
            Logout
          </a>
